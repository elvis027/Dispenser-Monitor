window.onload = function() {
    ...
    xhttp.onreadystatechange = function() {
        if(this.readyState==4 && this.status==200){
            document.getElementById("total").style.display = "block"; //顯示使用總數
            document.getElementById("loading").style.display = "none"; //關閉loading icon
            document.getElementById("chart1").style.display = "block"; //顯示第一張圖
            document.getElementById("chart2").style.display = "block"; //顯示第二張圖
            document.getElementById("title").innerHTML = "清大圖書館";
    ...
    xhttp.open("GET","http://localhost:8080/final/GUI/php/library.php",true);
    xhttp.send(null);
}
